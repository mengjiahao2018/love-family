...
CREATE TABLE `sys_function` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='系统功能表';

#
# Data for table "sys_function"
#

INSERT INTO `sys_function` VALUES (1,'1QXGL','权限管理','1','MENU','#QXGL'),(2,'1GNGL','功能管理','1','MENU','/templates/system/function.html'),(3,'2CDGL','菜单管理','1','MENU','/templates/system/menu.html'),(6,'3JSGL','角色管理','1','MENU','/templates/system/role.html'),(7,'4JSGNGL','角色功能管理','1','MENU','/templates/system/role-function.html'),(8,'5YHGL','用户管理','1','MENU','/templates/system/user.html'),(9,'6YHJSGL','用户角色管理','1','MENU','/templates/system/user-role.html');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='菜单设置表';

#
# Data for table "sys_menu"
#

INSERT INTO `sys_menu` VALUES (1,'1QXGL','fa fa-unlock-alt','权限管理',NULL,NULL,NULL),(2,'1GNGL',NULL,'功能管理',1,NULL,NULL),(3,'2CDGL',NULL,'菜单管理',1,NULL,NULL),(9,'3JSGL','','角色管理',1,NULL,NULL),(10,'4JSGNGL','','角色功能管理',1,NULL,NULL),(11,'5YHGL','','用户管理',1,NULL,NULL),(12,'6YHJSGL','','用户角色管理',1,NULL,NULL);
...
CREATE TABLE `sys_role` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='角色名';
...
CREATE TABLE `sys_role_function` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='系统角色功能表';

#
# Data for table "sys_role_function"
#

INSERT INTO `sys_role_function` VALUES (11,1,2),(12,1,1),(13,1,8),(14,1,3),(15,1,7),(16,1,6),(17,1,9);
...
INSERT INTO `sys_user` VALUES (1,'super_admin','$2a$10$Yw73QrfUu0rVbrjVMoy9OOspHpFJ3wi7hl7TIsVQ8l0/vGRWKwSqi',NULL,'超级管理员','1'),(2,'admin','$2a$10$fQdUda72mE/JbZ//oJDT3.RJLRKK2.v9k07XuvKoGDI76QVjwm24O',NULL,'管理员','1'),(3,'mengjiahao','$2a$10$x1sXmalzkxGZvmWYSQaGLeB/M389KAxpaYjP4nFRtPtb2FY2QlF9G',NULL,'孟钾濠','1'),(4,'zhangsan','$2a$10$Gwrl95.LNDp5iOvyacgoxeMUNMizCOJKQXPGNs8Wt0YUmQVnl6I96','zhangsan','张三','1'),(5,'lisi','$2a$10$QIlkAoOSbUTSP8fOk1EdPu0ECwtlZ4YvlcBnVI3n4bL.wFtWP6lKa','lisi','李四','1');
...
INSERT INTO `sys_user_role` VALUES (3,3,3),(4,2,3),(5,1,3);
