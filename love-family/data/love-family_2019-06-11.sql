...
CREATE TABLE `sys_function` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='系统功能表';

#
# Data for table "sys_function"
#

INSERT INTO `sys_function` VALUES (1,'A001','A001','A001','URL','html/index.html'),(2,'A002','A002','A002','URL','html/main.html');
...
CREATE TABLE `sys_role_function` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='系统角色功能表';

#
# Data for table "sys_role_function"
#

INSERT INTO `sys_role_function` VALUES (1,3,1),(2,3,2);
