...
CREATE TABLE `sys_function` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='系统功能表';

#
# Data for table "sys_function"
#

INSERT INTO `sys_function` VALUES (1,'1QXGL','权限管理','1','MENU','#QXGL'),(2,'1GNGL','功能管理','1','MENU','/templates/system/function.html'),(3,'2CDGL','菜单管理','1','MENU','/templates/system/menu.html'),(6,'3JSGL','角色管理','1','MENU','/templates/system/role.html'),(7,'4JSGNGL','角色功能管理','1','MENU','/templates/system/role-function.html');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='菜单设置表';

#
# Data for table "sys_menu"
#

INSERT INTO `sys_menu` VALUES (1,'1QXGL','fa fa-unlock-alt','权限管理',NULL,NULL,NULL),(2,'1GNGL',NULL,'功能管理',1,NULL,NULL),(3,'2CDGL',NULL,'菜单管理',1,NULL,NULL),(9,'3JSGL','','角色管理',1,NULL,NULL),(10,'4JSGNGL','','角色功能管理',1,NULL,NULL);
...
INSERT INTO `sys_role` VALUES (1,'ROLE_SUPER_ADMIN','超级管理员'),(2,'ROLE_ADMIN','管理员'),(3,'ROLE_USER','普通用户'),(7,'ROLE_TEST01','测试角色一'),(8,'ROLE_TEST02','测试角色二'),(9,'ROLE_TEST03','测试角色三'),(10,'ROLE_TEST04','测试角色四');
...
CREATE TABLE `sys_role_function` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='系统角色功能表';

#
# Data for table "sys_role_function"
#

INSERT INTO `sys_role_function` VALUES (1,3,1),(2,3,2),(3,3,3),(7,3,7),(9,3,6);
