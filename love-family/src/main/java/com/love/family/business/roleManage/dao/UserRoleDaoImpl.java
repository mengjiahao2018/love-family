...
@Repository
public class UserRoleDaoImpl extends BaseHibernate4QueryDao<SysRole> implements UserRoleDao {

	@Override
	public List findRolesByUserId(Long id) {
		StringBuffer buffer = new StringBuffer();
		buffer.append("from SysRole r where r.id in (select t.roleId from SysUserRole t where t.userId=:userId) ");
